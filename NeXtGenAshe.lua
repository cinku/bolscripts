...
if AUTO_UPDATE then
     CheckUpdate(SCRIPT_NAME, version, "raw.github.com", "raw.githubusercontent.com/cinkulol/bolscripts/master/NeXtGenAshe.lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "/cinkulol/bolscripts/master/"..SCRIPT_NAME..".version")
end
